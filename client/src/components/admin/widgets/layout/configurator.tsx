...
export function formatNumber(number: number, decPlaces: number): string {
...
export function Configurator() {
  ...
  useEffect(() => {
    fetch(
      ...
      .then((data) => {
        const formattedStars = formatNumber(data.stargazers_count, 1);
        setStars(+formattedStars); // Convert the formatted string to a number
      });
  }, []);
      ...
      <div className="py-4 px-6">
        ...
        <div className="mb-12">
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <Button
              variant={
                sidenavType === "transparent" ? "gradient" : "outlined"
              }
