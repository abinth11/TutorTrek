  ...
  return (
    <div className='w-full flex justify-center items-center '>
      <div className='w-11/12'>
        ...
        <div className='h-[30rem] flex gap-x-10'>
          <div className='border w-8/12 h-full  bg-white rounded-md border-gray-300'>
            <div className='flex h-full  flex-col justify-center items-center'>
              ...
              <div className='w-7/12'>
                ...
                <p className="text-sm ml-4 whitespace-pre-line text"> custom reminders and weekly progress reports.</p>
              </div>
          ...
          <div className='w-4/12 h-full border bg-white rounded-md border-gray-300'>
